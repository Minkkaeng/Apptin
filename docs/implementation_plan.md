# 📊 AppTin (앱틴) - PC & 모바일 통합 작업 일지 & AI 루틴 코어 구현 계획서

본 시스템은 사용자의 **PC 작업 내역(프로그램 사용 시간, 작업 내용)**과 **스마트폰 사용 내역(앱별 사용 시간, 켜짐 횟수)**을 백그라운드에서 자동으로 수집하여, 저녁마다 AI가 **일일 종합 리포트**와 **현대인 맞춤형 생활 루틴 피드백**을 제공하는 **앱틴 (AppTin = App + Routine)** 서비스입니다.
